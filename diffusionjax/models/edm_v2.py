# code ported to JAX from https://github.com/NVlabs/edm2/blob/main/training/networks_edm2.py
...
class Block(torch.nn.Module):
  def __init__(
    ...
    self.conv_res0 = MPConv(
      out_channels if flavor == "enc" else in_channels, out_channels, kernel=[3, 3]
    )
    ...
    self.attn_proj = (
      MPConv(out_channels, out_channels, kernel=[1, 1]) if self.num_heads != 0 else None
    )
