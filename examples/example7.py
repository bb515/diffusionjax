...
def main():
    ...
    def animate(i, ax):
        ...
        ax = plot_frame(ax, 1 - (i / 200), nabla_log_pt, nabla_log_hat_pt, trained_score) 
    ...
    score_model, params, opt_state = retrain_nn(2000, step_rng, mf, score_model, params, opt_state)
    trained_score = jit(lambda x, t: score_model.apply(params, x, t))

    plot_video(fig, ax, animate, 299, "plot_scorediff")
