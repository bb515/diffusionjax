###########################################################################
# Functions below are ported over from the ncsnpp codebase:
...
def get_sigmas(config):
  """Get sigmas --- the set of noise levels for SMLD (Score Matching
  with Langevin Dynamics) from config files.
  Args:
